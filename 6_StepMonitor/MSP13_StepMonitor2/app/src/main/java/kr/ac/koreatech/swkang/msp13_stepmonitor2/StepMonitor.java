package kr.ac.koreatech.swkang.msp13_stepmonitor2;
...
public class StepMonitor extends Service implements SensorEventListener {
    ...
    // SENSOR_DELAY_NORMAL로 가속도 데이터 수집 시 데이터 업데이트 주기는 약 80ms (Google Pixel 기준)
    // 따라서 초당 데이터 샘플 수는 12.5개
    // 이 값은 폰마다 다를 수 있으므로 확인 필요
    private static final int NUMBER_OF_SAMPLES = 13;
